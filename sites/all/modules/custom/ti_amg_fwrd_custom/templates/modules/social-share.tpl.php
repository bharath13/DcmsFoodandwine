...
<div class="social-share" 
  ...
  <div class="social-share__item social-share__item--has-count">
    <a id="p-social-share-button" target="_blank" href='http://pinterest.com/pin/create/link/?url=<?php print $url; ?>&amp;media=<?php print $social_share_content['social_share_img_path']; ?>&#x000A;&amp;description=<?php print $social_share_content['pinit_title']; ?>'>
  ...
  <div class="social-share__item">
    <a href='mailto:?subject=<?php print $social_share_content['mail_subject']; ?>&amp;body=<?php print $social_share_content['mail_body']; ?>?xid=emailsharebar' 
       id='email-button'>
  ...
  <?php if ($social_share_content['show_print_button']): ?>
    <div class="social-share__item">
